...
<div class="navbar-wrapper">
  ...
  <div class="carousel-inner" role="listbox">
	...
	if(request.querystring("genre")<>"") then
		genrev=request.querystring("genre")
		if (genrev="Show All") then
			sql="SELECT * FROM view_albums"
		else
		sql="SELECT * FROM view_albums where album_genre like "
		sql= sql & "'" & genrev & "'"
		'sql="SELECT * FROM view_albums where album_genre like 'Rock'"
		end if
	...
	%>
	<%
	if(request.cookies("albumsadded")("albumname")<>"") then%>
	Your last added album was: <% response.write(request.cookies("albumsadded")("albumname"))
	end if%>
	<br>
	Currently Chosen:  
	<%
